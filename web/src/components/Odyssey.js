...
import myImage from '../images/odyssey1.png';
...
function Odyssey() {
    ...
    return (
        <div>
            {/* <Header/> */}
            <a target="_blank" href="https://odyssey.iiitd.edu.in/">
                <div>
                    ...
                    <Col>
                        <Card style={styles.card}>
                            ...
                            <Card.Body>
                                ...
                                <Card.Text>
                                    <p>Link to the form for event registration for general public.</p>
                                </Card.Text>
                                <a target="_blank" href="https://docs.google.com/forms/d/e/1FAIpQLScIpkzATO2n4wnA-4a7Fw3aDnIpLfsKRNiCwyb_FHtkKWvQQQ/viewform">
